...
public class OnetimeAndPeriodicDifferentUniqueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WorkManager.getInstance()
                        .beginUniqueWork("uniqueA", ExistingWorkPolicy.KEEP, build)
                        .enqueue();
            }
        });
        ...
        WorkManager.getInstance()
                .enqueueUniquePeriodicWork("uniqueB", ExistingPeriodicWorkPolicy.KEEP, periodic);
    }
